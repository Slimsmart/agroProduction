	     ...
	     <div>
			...
			<legend>	<h3><a href="#" style="color: yellowgreen;">Average Estimates:</a></h3></legend>
            	...
            	<tr>               
                    ...
                    <tr>
                    	<th>Seeds</th>
                        <td><input type="text" value="<?php echo ("Naira ". $seeds); ?>" readonly="readonly"/></td>
						<th><label>Fertilizers</label></th>
						<td><input type="text" value="<?php echo ("Naira ". $fertilizers); ?>" autofocus=""></td>
						<th><label>Herbicides</label></th>
						<td><input type="text" value="<?php echo ("Naira ". $herbicides); ?>"></td>
						</tr>
                    <tr>
                    
                        <th>Labour</th>
                        <td><input type="text" value="<?php echo ("Naira ". $labour); ?>" readonly="readonly"/></td>
						<th><label>Tilling</label></th>
						<td><input type="text" value="<?php echo ("Naira ". $tilling); ?>" autofocus=""></td>
						<th><label>Planting</label></th>
						<td><input type="text" value="<?php echo ("Naira ". $planting); ?>"></td>
                    </tr>
                    <tr>
                    
                        <th>Weeding</th>
                        <td><input type="text" value="<?php echo ("Naira ". $weeding); ?>" readonly="readonly"/></td>
						<th><label>Harvesting</label></th>
						<td><input type="text" value="<?php echo ("Naira ". $harvesting); ?>" autofocus=""></td>
						<th><label>Storage</label></th>
						<td><input type="text" value="<?php echo ("Naira ". $storage); ?>"></td>
                    </tr>
                    ...
                    <tr>               
                	<th>Overheads</th>
                    <td><input type="text" value="<?php echo ("Naira ". $overheads); ?>" readonly="readonly"/></td>
                
						<th><label>Total</label></th>
						<td><input type="text" value="<?php echo ("Naira ". $total); ?>" autofocus=""></td>
						<th><label>Yields</label></th>
						<td><input type="text" value="<?php echo ("Naira ". $yields); ?>"></td>
						</tr>
					<tr>
                    <th>Profits</th>
                    <td><input type="text" value="<?php echo ("Naira ". $profit); ?>" style="color: red;"></td>
