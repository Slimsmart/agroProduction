...
<div id="cont">
	...
	<table>
        ...
        <tr>
        	<th>Country:</th>
            <td><input type="text" name="country" value="<?php echo $tr[6]; ?>" /></td>
       
        	<th>State:</th>
            <td><input type="text" name="State" value="<?php echo $tr[7]; ?>" /></td>
        ...
        <?php
       $i = mysql_query("update users set fname='".$_POST['fname']."', mname='".$_POST['mname']."', id_no='".$_POST['id_no']."', email='".$_POST['email']."', tel='".$_POST['tel']."', country='".$_POST['country']."',State='".$_POST['State']."',password='".$_POST['password']."',category='".$_POST['category']."',date='".$_POST['date']."',gender='".$_POST['gender']."' where id=".$_POST['id']);
        if($i==true){
